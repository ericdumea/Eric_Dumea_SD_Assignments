...
public class GameCore {
    ...
    private Player p;
    private PlayerDao playerDAO = DaoFactory.getInstance(DaoFactory.Type.JDBC).getPlayerDao();
    private MatchDao matchDAO = DaoFactory.getInstance(DaoFactory.Type.JDBC).getMatchDao();
